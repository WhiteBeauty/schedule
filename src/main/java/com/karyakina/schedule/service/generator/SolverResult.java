...
public record SolverResult(
    ...
    public enum Reason {
        ...
        NO_ROOM("подходящие аудитории заняты во все проверенные слоты"),
        NO_SUITABLE_ROOM_AT_ALL("нет вообще ни одной аудитории с достаточной вместимостью и допуском к этому предмету"),
